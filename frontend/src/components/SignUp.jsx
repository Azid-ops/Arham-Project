...
import { onSubFunc } from "./UserInfoFunc";
  ...
  return (
    <>
      <form
        ...
        className="border-2 border-black flex flex-col text-center"
      >
        ...
        <div className="bg-white w-11/12 sm:w-96 border-2 rounded-full self-center flex border-black focus-within:border-blue-600 focus-within:text-blue-600">
          <FontAwesomeIcon
            icon={faUser}
            className=" border-1 mt-1 ml-1 bg-none focus-input:text-blue-600"
          ></FontAwesomeIcon>
          <input
            required
            type="text"
            ...
            onChange={(a) => {
              ...
              validateEmail(a, validator, setMessage);
            }}
        ...
        <input
          type="submit"
          onClick={(e) => onSubFunc(e, setErrorMsg)}
